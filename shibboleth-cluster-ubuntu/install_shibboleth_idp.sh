...
#Change 128m to 512m
sed -i 's/128m/512m/g'  /etc/default/tomcat7

touch /etc/authbind/byport/8443
chmod 0755 /etc/authbind/byport/8443
chown tomcat7:tomcat7 /etc/authbind/byport/8443
